...
#Set Data
```{r}
df<-read.csv("https://raw.githubusercontent.com/Rheyhan/Project-TPG/main/DATA/Mentah.csv")
df <- drop_na(df)
```
...
write_xlsx(forexcel1, "D:/Kuliah/Semester 5/TPG/Tukhir/DATA/hasil/all.xlsx")
write_xlsx(forexcel2, "D:/Kuliah/Semester 5/TPG/Tukhir/DATA/hasil/4var.xlsx")
```
